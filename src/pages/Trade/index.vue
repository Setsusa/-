  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img width="150px" height="130px" :src="order.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ addressName.fullAddress }}</span>
        收货人：<span>{{ addressName.consignee }}</span>
        <span>{{ addressName.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async submitOrder() {
      ...
      let data = {
        consignee: this.addressName.consignee,
        consigneeTel: this.addressName.phoneNum,
        deliveryAddress: this.addressName.fullAddress,
        paymentWay: "ONLINE",
  ...
  computed: {
    ...
    totalNum() {
      return (this.orderInfo.detailArrayList || []).reduce((acc, curr) => {
        return acc + curr.skuNum;
      }, 0);
    },
    totalPrice() {
      return (this.orderInfo.detailArrayList || []).reduce((acc, curr) => {
        return acc + curr.orderPrice * curr.skuNum;
      }, 0);
    },
  },
};
