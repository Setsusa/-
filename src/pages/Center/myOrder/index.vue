<!--
 * @Author: your name
 * @Date: 2022-07-28 00:19:35
 * @LastEditTime: 2022-07-28 19:50:05
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \project-SPH\app\src\pages\Center\myOrder\index.vue
-->
<template>
            ...
            <tr v-for="(orderList, index) in order.orderDetailList" :key="orderList.id">
              <td width="60%">
                <div class="typographic">
                  <img width="100" height="100" :src="orderList.imgUrl" />
